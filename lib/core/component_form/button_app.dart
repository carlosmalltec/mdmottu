    ...
    return SizedBox(
      ...
      child: ButtonTheme(
        ...
        child: ElevatedButton(
          style: ButtonStyle(
            backgroundColor: MaterialStateProperty.all(colorBackground ?? ColorsApp.ff222E50),
            elevation: MaterialStateProperty.all(elevation ?? 0),
            textStyle: MaterialStateProperty.all(Theme.of(context).textTheme.displayMedium)
          ),
          onPressed: onPressed,
